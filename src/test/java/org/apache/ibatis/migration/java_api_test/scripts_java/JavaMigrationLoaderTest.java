...
public class JavaMigrationLoaderTest {
  ...
  public void testGetScriptReader() throws Exception {
    ...
    change.setFilename("org.apache.ibatis.migration.java_api_test.scripts_java.V002_CreateFirstTable");
  ...
  protected JavaMigrationLoader createMigrationLoader() {
    JavaMigrationLoader loader = new JavaMigrationLoader("org.apache.ibatis.migration.java_api_test.scripts_java");
    return loader;
  }
}
